...
export const collectionSourceMatchSchema = z.object({
  ...
  matchBasis: z.enum(["ic", "phone_and_account", "account_number", "card_number", "account_and_card"]),
  ...
  agingBucket: z.enum(["D3", "D4", "D5", "D6"]).optional(),
  cardNumberLast4: z.string().max(4).nullable().optional(),
