...
export type CollectionStoragePort = Pick<
  PostgresStorage,
  | "createAuditLog"
  | "backfillLegacyCollectionRecordsForSource"
  ...
  | "getCollectionRecordDailyRollupFreshness"
  ...
  | "deleteCollectionOspSavedTarget"
  | "getCollectionOspTargetOverview"
  | "listCollectionOspReconciliationCandidates"
  | "listCollectionOspManualReconciliations"
  | "createCollectionOspManualReconciliation"
  | "updateCollectionOspManualReconciliation"
  | "voidCollectionOspManualReconciliation"
  | "listCollectionOspReconciliationHistory"
  | "upsertCollectionOspClientResults"
  | "getCollectionOspCalendar"
  | "getCollectionOspDrilldown"
  | "getCollectionOspExportDataset"
