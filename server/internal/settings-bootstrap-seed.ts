...
const BASE_SETTINGS_SEED: SettingsSeedItem[] = [
  ...
  {
    categoryName: "Data Management",
    key: "activity_auto_cleanup_enabled",
    label: "Enable Activity Log Auto Cleanup",
    description: "Automatically remove eligible ended activity logs using the configured retention policy.",
    type: "boolean",
    value: "false",
    defaultValue: "false",
    isCritical: true,
  },
  {
    ...
    description: "Days to keep ordinary ended activity logs before they become eligible for cleanup.",
    type: "number",
    value: "90",
    defaultValue: "90",
    isCritical: false,
  ...
  {
    categoryName: "Data Management",
    key: "activity_security_retention_days",
    label: "Security Activity Retention (Days)",
    description: "Days to keep kicked and historical banned activity logs. Active bans are always protected.",
    type: "number",
    value: "365",
    defaultValue: "365",
    isCritical: false,
  ...
  {
    categoryName: "Data Management",
    key: "activity_retention_batch_size",
    label: "Activity Cleanup Batch Size",
    description: "Maximum activity log records removed by each automatic cleanup run.",
    type: "number",
    value: "500",
    defaultValue: "500",
    isCritical: false,
