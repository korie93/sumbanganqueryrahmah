...
// Keep equivalent to migration 0063; bootstrap also supports fresh local installs.
export async function ensureDeletedAccountGuards(database: BootstrapSqlExecutor): Promise<void> {
