...
export class PostgresActivityStorage extends PostgresImportsSearchStorage {
  ...
  async expireIdleActivitySessions(params: {
    idleCutoff: Date;
    idleMinutes: number;
  }): Promise<UserActivity[]> {
    return this.activityRepository.expireIdleActivitySessions(params);
  }
  ...
  async getActivityInvestigation(
    ...
    return this.activityRepository.getActivityInvestigation(id, relatedPage);
  }
