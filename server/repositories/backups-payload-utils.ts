    ...
    counts.collectionRecordsCount = await appendPagedJsonArray(state, "collectionRecords", (lastId) =>
      safeSelectBackupRows<(BackupCollectionRecord & BackupCursorRow) & Record<string, unknown>>(sql`
        SELECT
          ...
          settlement_override_status as "settlementOverrideStatus",
          pool_amount as "poolAmount",
          manual_settlement_date as "manualSettlementDate",
          manual_settlement_reason as "manualSettlementReason",
          manual_settlement_note as "manualSettlementNote",
          manual_settlement_reference as "manualSettlementReference",
          manual_settlement_version as "manualSettlementVersion",
          manual_settlement_verified_by as "manualSettlementVerifiedBy",
          manual_settlement_verified_at as "manualSettlementVerifiedAt",
          manual_settlement_updated_by as "manualSettlementUpdatedBy",
          manual_settlement_updated_at as "manualSettlementUpdatedAt",
          manual_settlement_revoked_by as "manualSettlementRevokedBy",
          manual_settlement_revoked_at as "manualSettlementRevokedAt",
          manual_settlement_revoked_reason as "manualSettlementRevokedReason",
          batch,
      ...
      (lastId) =>
        safeSelectBackupRows<BackupCollectionRecordPurgeHistory & BackupCursorRow>(sql`
          SELECT
            ...
            payment_date as "paymentDate",
            amount,
            automatic_classification as "automaticClassification",
            settlement_override_status as "settlementOverrideStatus",
            pool_amount as "poolAmount",
            manual_settlement_date as "manualSettlementDate",
            manual_settlement_reason as "manualSettlementReason",
