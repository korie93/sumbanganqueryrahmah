...
const runtimeEnvironmentShape = {
  ...
  SQR_RATE_LIMIT_AUTHENTICATED_IP_REQUESTS_PER_MINUTE: optionalIntEnv(
    "SQR_RATE_LIMIT_AUTHENTICATED_IP_REQUESTS_PER_MINUTE", { min: 600, max: 6_000_000 },
  ),
  SQR_RATE_LIMIT_LOGIN_IP_ATTEMPTS_PER_15_MINUTES: optionalIntEnv(
    "SQR_RATE_LIMIT_LOGIN_IP_ATTEMPTS_PER_15_MINUTES", { min: 100, max: 100_000 },
  ),
