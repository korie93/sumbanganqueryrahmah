...
export default function Import({ onNavigate, importUploadLimitBytes }: ImportProps) {
  ...
  return (
    <div className="app-shell-min-height bg-gradient-to-br from-slate-100 via-blue-50 to-slate-100 p-4 dark:from-background dark:via-card dark:to-background sm:p-6">
