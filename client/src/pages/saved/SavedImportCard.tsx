  ...
  return (
    ...
    >
        ...
        <div className="flex min-w-0 items-start gap-3">
          ...
          <div className="min-w-0 space-y-2">
            <div className="space-y-1">
              ...
              <p className="break-words text-sm text-muted-foreground">{item.filename}</p>
            </div>
            <div className="flex flex-wrap items-center gap-2">
      ...
      <div className="mt-3 grid grid-cols-1 gap-2 sm:flex sm:flex-wrap sm:items-center">
        <Button variant="outline" className="w-full sm:w-auto" onClick={() => onView(item)} data-testid={`button-view-${item.id}`}>
          <Eye className="mr-2 h-4 w-4" />
          View
        </Button>
        <Button variant="outline" className="w-full sm:w-auto" onClick={() => onAnalysis(item)} data-testid={`button-analysis-${item.id}`}>
