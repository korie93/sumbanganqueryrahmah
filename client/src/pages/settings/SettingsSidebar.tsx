    ...
    <>
      {isMobile ? (
        <div className="space-y-3 lg:hidden">
          <div className="rounded-[2rem] border border-border/60 bg-background/92 p-4 shadow-[0_20px_36px_-30px_hsl(222_47%_11%_/_0.18)] dark:border-border/70 dark:bg-card dark:shadow-[0_20px_36px_-28px_hsl(0_0%_0%_/_0.72)]">
