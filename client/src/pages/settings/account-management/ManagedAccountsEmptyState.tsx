import { LoaderCircle, SearchX, UserCog } from "lucide-react";
import { Button } from "@/components/ui/button";
import type { ManagedAccountsEmptyStateContent } from "@/pages/settings/account-management/managed-accounts-shared";

type ManagedAccountsEmptyStateProps = {
  state: ManagedAccountsEmptyStateContent;
  onClearFilters?: (() => void) | undefined;
};

function resolveEmptyStateIcon(state: ManagedAccountsEmptyStateContent) {
...
/**
 * Renders the shared managed-account empty state for desktop tables and mobile cards.
 */
export function ManagedAccountsEmptyState({
  state,
  onClearFilters,
}: ManagedAccountsEmptyStateProps) {
