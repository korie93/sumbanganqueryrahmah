    ...
    <Table className="min-w-[1100px] text-sm">
      <TableHeader>
        <TableRow>
          ...
          <TableHead className="sticky top-0 z-10 bg-background">Customer Phone Number</TableHead>
          ...
          <TableHead className="sticky top-0 z-10 bg-background">Payment Date</TableHead>
          <TableHead className="sticky top-0 z-10 bg-background">Receipt</TableHead>
