                  ...
                  <table className="w-full text-sm">
                    <thead className="sticky top-0 z-[var(--z-sticky-header)] bg-muted">
                      <tr>
                        ...
                        <th scope="col" className="p-3 text-left font-medium text-muted-foreground">Value</th>
                        <th scope="col" className="p-3 text-left font-medium text-muted-foreground">Count</th>
