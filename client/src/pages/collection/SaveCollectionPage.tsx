  ...
  return (
    <Card className={cn("border-border/60 bg-background/70", isMobile ? "overflow-hidden" : "")}>
      ...
      <CardContent className="space-y-4">
        ...
        <div
          className={cn(
            "-mx-6 flex flex-col gap-2 border-t border-border/60 bg-background/95 px-6 pt-3 pb-[calc(var(--safe-area-inset-bottom)+0.75rem)] shadow-lg backdrop-blur supports-[backdrop-filter]:bg-background/85 sm:static sm:mx-0 sm:flex-row sm:flex-wrap sm:justify-end sm:border-0 sm:bg-transparent sm:px-0 sm:pt-0 sm:pb-0 sm:shadow-none sm:backdrop-blur-0",
