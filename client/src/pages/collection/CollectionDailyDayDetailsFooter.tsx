...
export function CollectionDailyDayDetailsFooter({
  ...
  return (
    <div
      className={`sticky bottom-0 z-[var(--z-sticky-content)] flex flex-col gap-3 border-t border-border/60 bg-background/95 pb-[calc(var(--safe-area-inset-bottom)+0.75rem)] pt-3 text-sm shadow-lg sqr-backdrop-blur supports-[backdrop-filter]:bg-background/85 ${
