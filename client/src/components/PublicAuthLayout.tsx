...
export function PublicAuthLayout({
  ...
  return (
    <div className="relative viewport-min-height overflow-hidden bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
      ...
      <div className="absolute left-20 top-20 hidden h-56 w-56 rounded-full bg-blue-500/15 blur-3xl sm:block" />
      <div className="absolute bottom-20 right-20 hidden h-72 w-72 rounded-full bg-purple-500/15 blur-3xl sm:block" />
      <div className="absolute left-1/2 top-1/2 hidden h-[360px] w-[360px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-blue-400/8 blur-3xl md:block" />

      <main className="relative z-10 flex viewport-min-height items-center justify-center px-4 py-6 sm:py-8">
        <div className="w-full max-w-xl">
          ...
          <div className="pointer-events-none absolute -inset-4 hidden rounded-[2rem] bg-blue-400/12 blur-2xl sm:block" />

          <div className="relative overflow-hidden rounded-[2rem] border border-white/12 bg-slate-950/85 px-5 py-7 text-white shadow-2xl shadow-black/30 sm:bg-slate-950/75 sm:px-8 sm:py-8 sm:backdrop-blur-xl">
