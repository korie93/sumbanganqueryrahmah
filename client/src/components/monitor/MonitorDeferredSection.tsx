        ...
        <div className="grid grid-cols-1 gap-4 xl:grid-cols-4">
          {MONITOR_METRIC_FALLBACK_KEYS.map((key) => (
            <div
              ...
              className="h-72 animate-pulse rounded-2xl border border-border/60 bg-background/35 sqr-backdrop-blur-sm"
            />
          ))}
        </div>
      </div>
...
export function MonitorDeferredSectionToggle({
  ...
  return (
    <div className="rounded-2xl border border-border/60 bg-background/30 p-4 sqr-backdrop-blur-sm">
      {open ? (
        <button
          type="button"
