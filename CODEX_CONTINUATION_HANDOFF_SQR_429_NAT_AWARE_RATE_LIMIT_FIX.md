...
### Published harness and live CI evidence (2026-09-11 15:43 UTC checkpoint)

- Published initial harness `4b4aac0865829b9a91393c01c3ac89d37beaabcf`. Local `npm run test:scripts` passed363JS+51TS tests; secret scan, repo hygiene and stagedsecretguard passed. [NAT run34617086890](https://github.com/korie93/sumbanganqueryrahmah/actions/runs/34617086890) failed before readiness, with0browserparticipants/0edge requests. Its pinnedapplicationbuildmanifest correctly reported62cbe7aa andsourceDirty=false; this is not functional acceptance.
- Followup `879d52873c4bd3266b134a0d64cea85ad30ff118` corrected browseractivity storage to the real sessionStorage contract, explicitly isolated Nginxtemporarydirectories and added scrubbed startupdiagnosis. [NAT run34617484307](https://github.com/korie93/sumbanganqueryrahmah/actions/runs/34617484307) identified the exact blocker: application runtime rejects unknown `SQR_RELEASE_SHA`. This override belongs to buildmanifest creation, not runtimeenv. No productionbug or limiterfailure was demonstrated.
- Published `7004d16592f72cc5eb47d8c25dc2c3b603f0de22` removes the build-only override before migration/applicationstartup. All7dedicated contracttests passed; strict runtimevalidation remains unchanged. A new manualNATworkflow was dispatched at this harnessSHA; locate its exactcurrentrun via GitHub rather than rerunning oldfailedSHAs. NormalCI/CodeQL from earlier harnesscommits were still inprogress at thischeckpoint; no new productionReleaseVerification/deployment was dispatched.
- Verified sanitized artifacts:10270636598 SHA256`1771615d46d5cf5eb95b54af9f04bad5c41ecc429f0700866fdab7479e531b80` (run34617086890),10271357864 SHA256`6be9b8824a868d7af366fc87e885be3cc0301fef176473221dee06534c4bab9e` (run34617484307). Ignored extracted directories `artifacts/nat-simulation-<artifactId>/`; matchingGitHublogs are ignored `artifacts/github-run-<runId>-logs/`. Roothelper `artifacts/sqr-github-release.ps1` now supports explicitly separate `nat-dispatch` and `nat-download` actions with mainSHA/artifactSHA checks and token-free signedstorage download. Its original `dispatch` action still means productionReleaseVerification: do not confuse the two.
- Nextrequired outcome is an actual30account fullstackpass with inspectedbrowsercoverage, oneIP/per-layerstatus and resourceartifacts. Do not treat startup-only runs, localtests, commit/push, or the priorreal5accountday as that acceptance. Production/runtime/data remained untouched during these harnessruns.

Run34617761276 at7004d165 progressed through app/Nginxready, isolatedfixtureseeding and3distinctUIlogins. It failed on12Dashboard403responses fromuseraccounts, with0pageerrors,0edge/upstream429 and0HTTP5xx over505Nginxrequests. This independently reproduces the knownproductiondefaulttab-denialtraffic. The next harness classifies only the exactsixDashboardroutes'403responses foruser/admin after verifying the exactbackendtab-disabledmessage; fixtureassertsdefaultDashboardfalse/false/true foruser/admin/manager. It does not suppress manager403, otherbusiness4xx, any429or5xx, and keepsallresponses/denialcount inartifacts. This is preservedRBAC plus an explicitly recorded existingUIlimitation, not aclaimofbug-freefrontend or broadpermissionchange. RawUItrafficremainsinload. Asset-inclusive boundedrequestbudget is30000 because routedsafetyinterception disablesbrowserHTTPcache across about130fullpage navigations; per-layer/per-userlimiteracceptance is unchanged. Verifiedartifact10270382624 SHA256`8f9cd770d84b3d1ed919e8dfbb8aba239332d9f7a60ae35133a5893320805146` is ignoredlocally under `artifacts/nat-simulation-10270382624/`.
